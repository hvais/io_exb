...
function getUsers() {
    ...
    xmlUsers.open("GET", base_url + "controller/get_users.php");
    xmlUsers.send();
  }
  ...
  function getUser() {
    ...
    xmlUsers.open("GET", base_url + "controller/get_user.php?id="+id);
    xmlUsers.send();
  }

  function addUser() {
    var url =
      base_url + 'controller/add_user.php';
  ...
  function updateUser() {
    ...
    var url =
      base_url + 'controller/update_user.php?id='+id;
    var xhttp = new XMLHttpRequest();
    xhttp.open('POST', url, true);
  ...
  function deleteUser() {
    ...
    xmlUsers.open("GET", base_url + "controller/delete_user.php?id="+id);
    xmlUsers.send();
  }